...
const card_color = {
    ...
    danger: styles.card__color__danger
}

const card_decor = {
    secondary: styles.card__decor__secondary,
    warning: styles.card__decor__warning,
    danger: styles.card__decor__danger,
}
...
export default function ConnectionCard(props) {
    ...
    return (
            <div className="card cursor__pointer">
                <Ripples during={800} color={'rgb(44, 62, 80, 0.4)'} onClick={handleClick}>
                    <div className="card__wrapper">
                        ...
                        <div className={styles.card__content}>
                            ...
                            <div className={styles.card__description}>
                                <div><span>Host</span>: {props.host}</div>
                                <div><span>Port</span>: {props.port}</div>
                                <div><span>DB</span>: {props.db}</div>
                            </div>
                        </div>
                        <div className={`${styles.card__decor} ${card_decor[props.color]}`}>
